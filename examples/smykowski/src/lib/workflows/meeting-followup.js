...
export class MeetingFollowupWorkflow {
    constructor(github, extractor, schrute) {
        this.github = github;
        this.extractor = extractor;
        this.schrute = schrute;
    }
    /**
    ...
    async execute(email) {
        ...
        try {
            ...
            try {
                discussionNumber = await this.createDiscussionPost(email, actionItems, createdIssues, decisions);
            }
            catch (error) {
     ...
     */
    async createIssueFromActionItem(item, sourceEmail) {
     ...
     */
    async createDiscussionPost(email, actionItems, createdIssues, decisions) {
     ...
     */
    async sendConfirmationEmail(originalEmail, createdIssues, discussionNumber) {
...
//# sourceMappingURL=meeting-followup.js.map