...
export class IssueManager {
   ...
   * Create a new issue
   */
  async create(params: IssueCreationParams): Promise<GitHubIssue> {
    try {
   ...
   */
  async update(issueNumber: number, params: IssueUpdateParams): Promise<GitHubIssue> {
    try {
   ...
   */
  async list(filter: IssueQueryFilter = {}): Promise<GitHubIssue[]> {
    try {
   ...
   */
  async addAssignees(issueNumber: number, assignees: string[]): Promise<GitHubIssue> {
    try {
   ...
   * Close an issue
   */
  async close(issueNumber: number, comment?: string): Promise<GitHubIssue> {
    if (comment) {
   ...
   * Reopen an issue
   */
  async reopen(issueNumber: number, comment?: string): Promise<GitHubIssue> {
    if (comment) {
      await this.addComment(issueNumber, comment)
    }
   ...
   */
  async getAssignedTo(username: string): Promise<GitHubIssue[]> {
   ...
   */
  async getCreatedBy(username: string): Promise<GitHubIssue[]> {
   ...
   */
  async getByLabels(labels: string[]): Promise<GitHubIssue[]> {
   ...
   */
  async search(query: string): Promise<GitHubIssue[]> {
    try {
