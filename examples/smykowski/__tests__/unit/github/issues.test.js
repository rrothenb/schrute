...
describe('IssueManager', () => {
    ...
    describe('create', () => {
        it('should create an issue with all fields', async () => {
            ...
            expect(mockClient.getOctokit().issues.create).toHaveBeenCalledWith(expect.objectContaining({
                owner: 'test',
                repo: 'repo',
                title: 'Test Issue',
                body: 'Test body',
    ...
    describe('list', () => {
        it('should list all open issues by default', async () => {
            ...
            expect(mockClient.getOctokit().issues.listForRepo).toHaveBeenCalledWith(expect.objectContaining({
                state: 'open',
            }));
        });
    ...
    describe('update', () => {
        it('should update issue fields', async () => {
            ...
            expect(mockClient.getOctokit().issues.update).toHaveBeenCalledWith(expect.objectContaining({
                issue_number: 123,
                title: 'Updated Title',
                state: 'closed',
            }));
