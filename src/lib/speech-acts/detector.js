...
export class SpeechActDetector {
    ...
    async detectSpeechActs(email) {
        ...
        try {
            const detected = await this.client.promptJson(prompt, {
     ...
     */
    async detectSpeechActsBatch(emails) {
