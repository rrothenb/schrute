...
import type { Email, EmailSummary, EmailAddress } from '~/lib/types'
...
Return ONLY a JSON object with this structure:
{
  ...
  const result = await client.promptJson(prompt) as { summary: string; key_points: string[] }
 ...
 */
export async function summarizeEmailBatches(
  emailGroups: Email[][],
  threadId: string
): Promise<EmailSummary[]> {
